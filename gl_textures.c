...
cvar_t gl_texture_filter = {CVAR_SAVE, "gl_texture_filter", "GL_LINEAR", "texture filtering (GL_NEAREST, GL_NEAREST_MIPMAP_NEAREST, GL_NEAREST_MIPMAP_LINEAR, GL_LINEAR, GL_LINEAR_MIPMAP_NEAREST, GL_LINEAR_MIPMAP_LINEAR)"};
...
void R_Textures_Init (void)
{
	...
	Cvar_RegisterVariable (&gl_texture_filter);
